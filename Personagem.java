...
public class Personagem {
    ...
    public Personagem(String nome,int level,int vidaMaxima,double vidaAtual, double defesa_Per, int almasatuais, double cargaMaxima, double carga_atual, int vigor,int resistencia,int vitalidade,int sintonização,int forca,int destreza,double adaptabilidade,int inteligencia, int fé,String equipMdeireita,String equipMesquerda, Area[] localizacao_atual){
        this.nome = nome;
        this.level = level;
        vidaMAX = vidaMaxima;
